    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(mStoryLeftIndex == 1){
                    mStoryText.setText(R.string.T6_End);
                    mButtonTop.setVisibility(View.GONE);
                    mButtonBottom.setVisibility(View.GONE);
                    mStoryLeftIndex++;
                }
                else if(mStoryLeftIndex == 1 && mStoryRightIndex == 1){
                    mStoryText.setText(R.string.T3_Story);
                    mButtonTop.setText(R.string.T3_Ans1);
                    mButtonBottom.setText(R.string.T3_Ans2);
                    mStoryLeftIndex++;
                }
                else if (mStoryLeftIndex == 2 && mStoryRightIndex == 1){
                    mStoryText.setText(R.string.T6_End);
                    mButtonTop.setVisibility(View.GONE);
                    mButtonBottom.setVisibility(View.GONE);
                    mStoryRightIndex++;
        ...
        mButtonBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if(mStoryLeftIndex == 1 && mStoryRightIndex == 0 ){
               ...
               else if(mStoryLeftIndex == 0 && mStoryRightIndex  == 0){
               ...
               else if(mStoryLeftIndex == 0 && mStoryRightIndex == 1){
